...
//  //?   // UniquePtr<int[]> ptr2{new int[200]{}};  // use ~Unique_ptr() {delete[]ptr;}
//   }
//   {
...
//   }
  ...
  {
    // SharedPtr<int[]> ptr2{new int[200]{}};  // use ~Shared_ptr() {delete[]
    // ptr;}
  }

  {
    // auto file = fopen("file_name","r");
    // SharedPtr<std::FILE> ptr{file, fclose};  // use ~Shared_ptr() {fclose(ptr);}
  }
